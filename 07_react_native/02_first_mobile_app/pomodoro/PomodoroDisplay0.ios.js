...
import { StyleSheet, Text, TouchableHighlight, View, Animated, Button } from "react-native";
...
function titleScreen(start) {
  return (
    <View style={styles.titleScreen}>
      ...
      <Animated.Text style={[styles.title, {backgroundColor: 'transparent'}, {opacity: opacity}]}>
        Good Job
        {animate()}
      </Animated.Text>
